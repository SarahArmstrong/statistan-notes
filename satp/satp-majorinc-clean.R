...
df1988_2006 = rename(df1988_2006, c('df..i..' = 'Incidents'))
df2007_2012 = rename(df2007_2012, c('X0' = 'Incidents'))
...
df1988_2012 <- df1988_2012[!(df1988_2012$Incidents == ' '), ]
dat <- df1988_2012
...
dat$Incidents <- as.character(dat$Incidents)
dat$District <- NA
dat$Province <- NA
...
dat = rename(dat, c('C.Killed' = 'Civilians_killed'))
dat = rename(dat, c('SFs.Killed' = 'SecForces_killed'))
dat = rename(dat, c('T.Killed' = 'Terrorists_kiled'))
dat = rename(dat, c('Total.Killed' = 'Total_killed'))
